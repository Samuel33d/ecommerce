...
export default function Footer() {
  return (
    <footer className="relative bg-surface-950 text-surface-400 overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-32 bg-primary-600/10 rounded-full blur-3xl" />
